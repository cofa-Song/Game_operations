export const zhTW = {
  ...
  navigation: {
    ...
    agentReport: '代理統計報表',
    vipSettings: 'VIP等級設定',
    systemOperations: '系統管理',
    marketingOperations: '營運管理',
    csChannels: '客服通道管理',
    smsProviders: '簡訊商管理',
    csManagement: '客服管理',
    csWorkbench: '客服工作台',
    csPlayerSearch: '玩家對話查詢',
    csWorldMonitor: '世界頻道監控',
    frontendManagement: '前台管理',
    promotionManagement: '優惠管理',
    missionManagement: '任務管理',
  ...
  vip: {
    ...
    retainDeposit: '月累計儲值',
    retainTurnover: '月累計流水',
    retainActiveDays: '月活躍天數',
    rewards: '獎勵設定',
    feeRate: 'P2P 手續費 (%)',
    rebateRate: '投注返水 (%)'
  },
...
export const zhCN = {
  ...
  navigation: {
    ...
    agentReport: '代理统计报表',
    vipSettings: 'VIP等级设定',
    systemOperations: '系统管理',
    marketingOperations: '内容管理',
    ...
    csManagement: '客服管理',
    csWorkbench: '客服工作台',
    csPlayerSearch: '玩家对话查询',
    csWorldMonitor: '世界频道监控',
    frontendManagement: '前台管理',
    promotionManagement: '优惠管理',
...
export const en = {
  ...
  navigation: {
    ...
    agentReport: 'Agent Statistics Report',
    vipSettings: 'VIP Level Settings',
    systemOperations: 'System Management',
    marketingOperations: 'Content Management',
    csChannels: 'CS Channel Management',
    smsProviders: 'SMS Provider Management',
    csManagement: 'Customer Service',
    csWorkbench: 'CS Workbench',
    csPlayerSearch: 'Player Chat History',
    csWorldMonitor: 'World Channel Monitor',
    frontendManagement: 'Frontend Management',
  ...
  gameLogs: {
    ...
    currency: 'Currency',
    currencyAll: 'All',
    currencyGold: 'Gold Coin',
    currencySilver: 'Silver Coin',
    search: 'Search',
