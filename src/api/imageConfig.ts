...
export const mockImageConfigs: ImageConfig[] = [
    {
        ...
        title: '新春活動主 Banner',
        pcImageUrl: 'https://via.placeholder.com/1920x450/FF0000/FFFFFF?text=CNY+Banner+PC',
        mobileImageUrl: 'https://via.placeholder.com/750x300/FF0000/FFFFFF?text=CNY+Banner+Mobile',
    ...
    },
    {
        ...
        title: '每日簽到提醒',
        pcImageUrl: 'https://via.placeholder.com/600x600/0000FF/FFFFFF?text=Daily+Login+PC',
        mobileImageUrl: 'https://via.placeholder.com/400x400/0000FF/FFFFFF?text=Daily+Login+Mobile',
        jumpUrl: '',
        startTime: yesterday,
        endTime: oneYearLater,
        weight: 10,
    ...
    },
    {
        ...
        type: ImageType.BANNER,
        title: 'VIP 專屬優惠',
        pcImageUrl: 'https://via.placeholder.com/1920x450/FFD700/000000?text=VIP+Banner+PC',
        mobileImageUrl: 'https://via.placeholder.com/750x300/FFD700/000000?text=VIP+Banner+Mobile',
        jumpUrl: '/vip',
        startTime: tomorrow,
        endTime: oneYearLater,
        weight: 2,
