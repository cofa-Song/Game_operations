...
import { Game, GameListSearchParams, GameUpdateRequest, MarketingTag } from '@/types/game'
...
let mockGames: Game[] = [
    // PG Games
    { id: 'G001', provider_id: 'PV-001', provider_game_id: 'PG_MAHJONG2', type_id: 'T001', name: '麻將胡了2', name_en: 'Mahjong Ways 2', monthly_turnover: 1250000, marketing_tag: 'HOT', tag_source: 'AUTO', type_rate: 100, tag_rate: 150, final_rate: 150, allowed_currencies: ['GOLD', 'SILVER'], min_vip_level: 0, sort_order: 1, status: 'ACTIVE', updated_at: '2026-01-29T10:00:00Z' },
    { id: 'G002', provider_id: 'PV-001', provider_game_id: 'PG_NEKO', type_id: 'T001', name: '招財貓', name_en: 'Lucky Neko', monthly_turnover: 850000, marketing_tag: 'RECOMMENDED', tag_source: 'MANUAL', type_rate: 100, tag_rate: 120, final_rate: 120, allowed_currencies: ['GOLD'], min_vip_level: 0, sort_order: 3, status: 'ACTIVE', updated_at: '2026-01-28T14:00:00Z' },
    { id: 'G003', provider_id: 'PV-001', provider_game_id: 'PG_AZTEC', type_id: 'T001', name: '阿茲特克寶藏', name_en: 'Treasures of Aztec', monthly_turnover: 450000, marketing_tag: null, tag_source: 'AUTO', type_rate: 100, tag_rate: 0, final_rate: 100, allowed_currencies: ['GOLD', 'SILVER'], min_vip_level: 0, sort_order: 10, status: 'ACTIVE', updated_at: '2026-01-20T10:00:00Z' },

    // JILI Games
    { id: 'G004', provider_id: 'PV-003', provider_game_id: 'JILI_SUPERACE', type_id: 'T001', name: '超級王牌', name_en: 'Super Ace', monthly_turnover: 2100000, marketing_tag: 'DOUBLE_TURNOVER', tag_source: 'MANUAL', type_rate: 100, tag_rate: 200, final_rate: 200, allowed_currencies: ['GOLD', 'SILVER'], min_vip_level: 0, sort_order: 2, status: 'ACTIVE', updated_at: '2026-01-27T16:00:00Z' },
    { id: 'G005', provider_id: 'PV-003', provider_game_id: 'JILI_EMPIRE', type_id: 'T001', name: '黃金帝國', name_en: 'Golden Empire', monthly_turnover: 680000, marketing_tag: null, tag_source: 'AUTO', type_rate: 100, tag_rate: 0, final_rate: 100, allowed_currencies: ['GOLD'], min_vip_level: 1, sort_order: 8, status: 'ACTIVE', updated_at: '2026-01-25T10:00:00Z' },
    { id: 'G006', provider_id: 'PV-003', provider_game_id: 'JILI_BOXING', type_id: 'T001', name: '拳擊之王', name_en: 'Boxing King', monthly_turnover: 120000, marketing_tag: null, tag_source: 'AUTO', type_rate: 100, tag_rate: 0, final_rate: 100, allowed_currencies: ['SILVER'], min_vip_level: 0, sort_order: 20, status: 'DISABLED', updated_at: '2026-01-15T09:00:00Z' },

    // Evolution Games
    { id: 'G007', provider_id: 'PV-002', provider_game_id: 'EVO_CRAZYTIME', type_id: 'T002', name: '瘋狂時刻', name_en: 'Crazy Time', monthly_turnover: 3500000, marketing_tag: 'HOT', tag_source: 'AUTO', type_rate: 80, tag_rate: 150, final_rate: 150, allowed_currencies: ['GOLD'], min_vip_level: 0, sort_order: 1, status: 'ACTIVE', updated_at: '2026-01-29T08:00:00Z' },
    { id: 'G008', provider_id: 'PV-002', provider_game_id: 'EVO_LIGHTNING', type_id: 'T002', name: '閃電輪盤', name_en: 'Lightning Roulette', monthly_turnover: 1800000, marketing_tag: 'RECOMMENDED', tag_source: 'AUTO', type_rate: 80, tag_rate: 120, final_rate: 120, allowed_currencies: ['GOLD'], min_vip_level: 2, sort_order: 5, status: 'ACTIVE', updated_at: '2026-01-28T10:00:00Z' },
    { id: 'G009', provider_id: 'PV-002', provider_game_id: 'EVO_BACCARAT_A', type_id: 'T002', name: '百家樂 A', name_en: 'Baccarat A', monthly_turnover: 5200000, marketing_tag: null, tag_source: 'AUTO', type_rate: 80, tag_rate: 0, final_rate: 80, allowed_currencies: ['GOLD'], min_vip_level: 3, sort_order: 4, status: 'ACTIVE', updated_at: '2026-01-26T14:00:00Z' },

    // PP Games
    { id: 'G010', provider_id: 'PV-004', provider_game_id: 'PP_GATES', type_id: 'T001', name: '眾神之門', name_en: 'Gates of Olympus', monthly_turnover: 980000, marketing_tag: 'HOT', tag_source: 'MANUAL', type_rate: 100, tag_rate: 150, final_rate: 150, allowed_currencies: ['GOLD', 'SILVER'], min_vip_level: 0, sort_order: 6, status: 'ACTIVE', updated_at: '2026-01-28T12:00:00Z' },
    { id: 'G011', provider_id: 'PV-004', provider_game_id: 'PP_BONANZA', type_id: 'T001', name: '甜蜜糖果', name_en: 'Sweet Bonanza', monthly_turnover: 620000, marketing_tag: null, tag_source: 'AUTO', type_rate: 100, tag_rate: 0, final_rate: 100, allowed_currencies: ['GOLD'], min_vip_level: 0, sort_order: 12, status: 'ACTIVE', updated_at: '2026-01-22T10:00:00Z' },

    // KY Games
    { id: 'G012', provider_id: 'PV-006', provider_game_id: 'KY_BIRD', type_id: 'T001', name: '捕鳥達人', name_en: 'Birds Party', monthly_turnover: 350000, marketing_tag: null, tag_source: 'AUTO', type_rate: 100, tag_rate: 0, final_rate: 100, allowed_currencies: ['SILVER'], min_vip_level: 0, sort_order: 15, status: 'ACTIVE', updated_at: '2026-01-20T08:00:00Z' },
    { id: 'G013', provider_id: 'PV-006', provider_game_id: 'KY_DRAGON', type_id: 'T001', name: '神龍寶藏', name_en: 'Dragon Master', monthly_turnover: 180000, marketing_tag: null, tag_source: 'AUTO', type_rate: 100, tag_rate: 0, final_rate: 100, allowed_currencies: ['GOLD', 'SILVER'], min_vip_level: 1, sort_order: 18, status: 'ACTIVE', updated_at: '2026-01-18T10:00:00Z' }
]
