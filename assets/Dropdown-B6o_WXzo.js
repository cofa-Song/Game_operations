import{B as xe,V as Se,a as Ne,r as Re,N as Pe,p as ae}from"./Popover-Dnwd67oy.js";import{r as T,B as se,e as z,h as d,k as re,aS as V,n as B,aI as ue,aY as ke,aT as G,j as w,aZ as ce,p as H,I as Ke,aL as Ie,a_ as Ce,a$ as Oe,b0 as _e,c as x,b1 as $e,a as E,aa as ie,b as k,d as $,az as ze,aR as De,u as Ae,f as pe,g as Fe,b2 as Te,aC as oe,t as K,af as F}from"./index-CsuCc73U.js";import{N as Be}from"./Icon-B1opSJnU.js";import{h as de,c as je}from"./create-DP2bjekl.js";import{u as Le}from"./use-keyboard-R-4Cc9Nj.js";import{c as Me}from"./create-ref-setter-C4J8sofl.js";function Ee(e,t,a){const r=T(e.value);let n=null;return se(e,o=>{n!==null&&window.clearTimeout(n),o===!0?a&&!a.value?r.value=!0:n=window.setTimeout(()=>{r.value=!0},t):r.value=!1}),r}const He=z({name:"ChevronRight",render(){return d("svg",{viewBox:"0 0 16 16",fill:"none",xmlns:"http://www.w3.org/2000/svg"},d("path",{d:"M5.64645 3.14645C5.45118 3.34171 5.45118 3.65829 5.64645 3.85355L9.79289 8L5.64645 12.1464C5.45118 12.3417 5.45118 12.6583 5.64645 12.8536C5.84171 13.0488 6.15829 13.0488 6.35355 12.8536L10.8536 8.35355C11.0488 8.15829 11.0488 7.84171 10.8536 7.64645L6.35355 3.14645C6.15829 2.95118 5.84171 2.95118 5.64645 3.14645Z",fill:"currentColor"}))}}),te=re("n-dropdown-menu"),Z=re("n-dropdown"),le=re("n-dropdown-option"),fe=z({name:"DropdownDivider",props:{clsPrefix:{type:String,required:!0}},render(){return d("div",{class:`${this.clsPrefix}-dropdown-divider`})}}),Ue=z({name:"DropdownGroupHeader",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0}},setup(){const{showIconRef:e,hasSubmenuRef:t}=B(te),{renderLabelRef:a,labelFieldRef:r,nodePropsRef:n,renderOptionRef:o}=B(Z);return{labelField:r,showIcon:e,hasSubmenu:t,renderLabel:a,nodeProps:n,renderOption:o}},render(){var e;const{clsPrefix:t,hasSubmenu:a,showIcon:r,nodeProps:n,renderLabel:o,renderOption:p}=this,{rawNode:f}=this.tmNode,c=d("div",Object.assign({class:`${t}-dropdown-option`},n==null?void 0:n(f)),d("div",{class:`${t}-dropdown-option-body ${t}-dropdown-option-body--group`},d("div",{"data-dropdown-option":!0,class:[`${t}-dropdown-option-body__prefix`,r&&`${t}-dropdown-option-body__prefix--show-icon`]},V(f.icon)),d("div",{class:`${t}-dropdown-option-body__label`,"data-dropdown-option":!0},o?o(f):V((e=f.title)!==null&&e!==void 0?e:f[this.labelField])),d("div",{class:[`${t}-dropdown-option-body__suffix`,a&&`${t}-dropdown-option-body__suffix--has-submenu`],"data-dropdown-option":!0})));return p?p({node:c,option:f}):c}});function ne(e,t){return e.type==="submenu"||e.type===void 0&&e[t]!==void 0}function We(e){return e.type==="group"}function ve(e){return e.type==="divider"}function qe(e){return e.type==="render"}const he=z({name:"DropdownOption",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0},parentKey:{type:[String,Number],default:null},placement:{type:String,default:"right-start"},props:Object,scrollable:Boolean},setup(e){const t=B(Z),{hoverKeyRef:a,keyboardKeyRef:r,lastToggledSubmenuKeyRef:n,pendingKeyPathRef:o,activeKeyPathRef:p,animatedRef:f,mergedShowRef:c,renderLabelRef:S,renderIconRef:g,labelFieldRef:N,childrenFieldRef:I,renderOptionRef:R,nodePropsRef:C,menuPropsRef:j}=t,m=B(le,null),O=B(te),U=B(ce),X=w(()=>e.tmNode.rawNode),W=w(()=>{const{value:l}=I;return ne(e.tmNode.rawNode,l)}),Y=w(()=>{const{disabled:l}=e.tmNode;return l}),J=w(()=>{if(!W.value)return!1;const{key:l,disabled:b}=e.tmNode;if(b)return!1;const{value:P}=a,{value:D}=r,{value:ee}=n,{value:A}=o;return P!==null?A.includes(l):D!==null?A.includes(l)&&A[A.length-1]!==l:ee!==null?A.includes(l):!1}),Q=w(()=>r.value===null&&!f.value),q=Ee(J,300,Q),L=w(()=>!!(m!=null&&m.enteringSubmenuRef.value)),M=T(!1);H(le,{enteringSubmenuRef:M});function _(){M.value=!0}function i(){M.value=!1}function h(){const{parentKey:l,tmNode:b}=e;b.disabled||c.value&&(n.value=l,r.value=null,a.value=b.key)}function u(){const{tmNode:l}=e;l.disabled||c.value&&a.value!==l.key&&h()}function s(l){if(e.tmNode.disabled||!c.value)return;const{relatedTarget:b}=l;b&&!de({target:b},"dropdownOption")&&!de({target:b},"scrollbarRail")&&(a.value=null)}function y(){const{value:l}=W,{tmNode:b}=e;c.value&&!l&&!b.disabled&&(t.doSelect(b.key,b.rawNode),t.doUpdateShow(!1))}return{labelField:N,renderLabel:S,renderIcon:g,siblingHasIcon:O.showIconRef,siblingHasSubmenu:O.hasSubmenuRef,menuProps:j,popoverBody:U,animated:f,mergedShowSubmenu:w(()=>q.value&&!L.value),rawNode:X,hasSubmenu:W,pending:G(()=>{const{value:l}=o,{key:b}=e.tmNode;return l.includes(b)}),childActive:G(()=>{const{value:l}=p,{key:b}=e.tmNode,P=l.findIndex(D=>b===D);return P===-1?!1:P<l.length-1}),active:G(()=>{const{value:l}=p,{key:b}=e.tmNode,P=l.findIndex(D=>b===D);return P===-1?!1:P===l.length-1}),mergedDisabled:Y,renderOption:R,nodeProps:C,handleClick:y,handleMouseMove:u,handleMouseEnter:h,handleMouseLeave:s,handleSubmenuBeforeEnter:_,handleSubmenuAfterEnter:i}},render(){var e,t;const{animated:a,rawNode:r,mergedShowSubmenu:n,clsPrefix:o,siblingHasIcon:p,siblingHasSubmenu:f,renderLabel:c,renderIcon:S,renderOption:g,nodeProps:N,props:I,scrollable:R}=this;let C=null;if(n){const U=(e=this.menuProps)===null||e===void 0?void 0:e.call(this,r,r.children);C=d(be,Object.assign({},U,{clsPrefix:o,scrollable:this.scrollable,tmNodes:this.tmNode.children,parentKey:this.tmNode.key}))}const j={class:[`${o}-dropdown-option-body`,this.pending&&`${o}-dropdown-option-body--pending`,this.active&&`${o}-dropdown-option-body--active`,this.childActive&&`${o}-dropdown-option-body--child-active`,this.mergedDisabled&&`${o}-dropdown-option-body--disabled`],onMousemove:this.handleMouseMove,onMouseenter:this.handleMouseEnter,onMouseleave:this.handleMouseLeave,onClick:this.handleClick},m=N==null?void 0:N(r),O=d("div",Object.assign({class:[`${o}-dropdown-option`,m==null?void 0:m.class],"data-dropdown-option":!0},m),d("div",ue(j,I),[d("div",{class:[`${o}-dropdown-option-body__prefix`,p&&`${o}-dropdown-option-body__prefix--show-icon`]},[S?S(r):V(r.icon)]),d("div",{"data-dropdown-option":!0,class:`${o}-dropdown-option-body__label`},c?c(r):V((t=r[this.labelField])!==null&&t!==void 0?t:r.title)),d("div",{"data-dropdown-option":!0,class:[`${o}-dropdown-option-body__suffix`,f&&`${o}-dropdown-option-body__suffix--has-submenu`]},this.hasSubmenu?d(Be,null,{default:()=>d(He,null)}):null)]),this.hasSubmenu?d(xe,null,{default:()=>[d(Se,null,{default:()=>d("div",{class:`${o}-dropdown-offset-container`},d(Ne,{show:this.mergedShowSubmenu,placement:this.placement,to:R&&this.popoverBody||void 0,teleportDisabled:!R},{default:()=>d("div",{class:`${o}-dropdown-menu-wrapper`},a?d(ke,{onBeforeEnter:this.handleSubmenuBeforeEnter,onAfterEnter:this.handleSubmenuAfterEnter,name:"fade-in-scale-up-transition",appear:!0},{default:()=>C}):C)}))})]}):null);return g?g({node:O,option:r}):O}}),Ge=z({name:"NDropdownGroup",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0},parentKey:{type:[String,Number],default:null}},render(){const{tmNode:e,parentKey:t,clsPrefix:a}=this,{children:r}=e;return d(Ke,null,d(Ue,{clsPrefix:a,tmNode:e,key:e.key}),r==null?void 0:r.map(n=>{const{rawNode:o}=n;return o.show===!1?null:ve(o)?d(fe,{clsPrefix:a,key:n.key}):n.isGroup?(Ie("dropdown","`group` node is not allowed to be put in `group` node."),null):d(he,{clsPrefix:a,tmNode:n,parentKey:t,key:n.key})}))}}),Ve=z({name:"DropdownRenderOption",props:{tmNode:{type:Object,required:!0}},render(){const{rawNode:{render:e,props:t}}=this.tmNode;return d("div",t,[e==null?void 0:e()])}}),be=z({name:"DropdownMenu",props:{scrollable:Boolean,showArrow:Boolean,arrowStyle:[String,Object],clsPrefix:{type:String,required:!0},tmNodes:{type:Array,default:()=>[]},parentKey:{type:[String,Number],default:null}},setup(e){const{renderIconRef:t,childrenFieldRef:a}=B(Z);H(te,{showIconRef:w(()=>{const n=t.value;return e.tmNodes.some(o=>{var p;if(o.isGroup)return(p=o.children)===null||p===void 0?void 0:p.some(({rawNode:c})=>n?n(c):c.icon);const{rawNode:f}=o;return n?n(f):f.icon})}),hasSubmenuRef:w(()=>{const{value:n}=a;return e.tmNodes.some(o=>{var p;if(o.isGroup)return(p=o.children)===null||p===void 0?void 0:p.some(({rawNode:c})=>ne(c,n));const{rawNode:f}=o;return ne(f,n)})})});const r=T(null);return H(Oe,null),H(_e,null),H(ce,r),{bodyRef:r}},render(){const{parentKey:e,clsPrefix:t,scrollable:a}=this,r=this.tmNodes.map(n=>{const{rawNode:o}=n;return o.show===!1?null:qe(o)?d(Ve,{tmNode:n,key:n.key}):ve(o)?d(fe,{clsPrefix:t,key:n.key}):We(o)?d(Ge,{clsPrefix:t,tmNode:n,parentKey:e,key:n.key}):d(he,{clsPrefix:t,tmNode:n,parentKey:e,key:n.key,props:o.props,scrollable:a})});return d("div",{class:[`${t}-dropdown-menu`,a&&`${t}-dropdown-menu--scrollable`],ref:"bodyRef"},a?d(Ce,{contentClass:`${t}-dropdown-menu__content`},{default:()=>r}):r,this.showArrow?Re({clsPrefix:t,arrowStyle:this.arrowStyle,arrowClass:void 0,arrowWrapperClass:void 0,arrowWrapperStyle:void 0}):null)}}),Ze=x("dropdown-menu",`
