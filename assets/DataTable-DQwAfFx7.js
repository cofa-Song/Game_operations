...
`)}const hn=ae({name:"DataTableBodyCheckbox",props:{rowKey:{type:[String,Number],required:!0},disabled:{type:Boolean,required:!0},onUpdateChecked:{type:Function,required:!0}},setup(e){const{mergedCheckedRowKeySetRef:r,mergedInderminateRowKeySetRef:t}=ze(Te);return()=>{const{rowKey:n}=e;return o(wt,{privateInsideTable:!0,disabled:e.disabled,indeterminate:t.value.has(n),checked:r.value.has(n),onUpdateChecked:e.onUpdateChecked})}}}),gn=ae({name:"DataTableBodyRadio",props:{rowKey:{type:[String,Number],required:!0},disabled:{type:Boolean,required:!0},onUpdateChecked:{type:Function,required:!0}},setup(e){const{mergedCheckedRowKeySetRef:r,componentId:t}=ze(Te);return()=>{const{rowKey:n}=e;return o(It,{name:t,disabled:e.disabled,checked:r.value.has(n),onUpdateChecked:e.onUpdateChecked})}}}),Gt=T("ellipsis",{overflow:"hidden"},[mt("line-clamp",`
 ...
 `,[Mr({originalTransform:"translateX(-50%) translateY(-50%)"})])]),T("data-table-expand-placeholder",`
 margin-right: 8px;
 display: inline-block;
 width: 16px;
 height: 1px;
 ...
 transition: color .3s var(--n-bezier);
 `,[D("expanded",[T("icon","transform: rotate(90deg);",[Je({originalTransform:"rotate(90deg)"})]),T("base-icon","transform: rotate(90deg);",[Je({originalTransform:"rotate(90deg)"})])]),T("base-loading",`
 color: var(--n-loading-color);
 transition: color .3s var(--n-bezier);
 position: absolute;
 left: 0;
 ...
 transition: box-shadow .2s var(--n-bezier);
 left: -36px;
 `)])]}function An(e,r){const{paginatedDataRef:t,treeMateRef:n,selectionColumnRef:a}=r,l=j(e.defaultCheckedRowKeys),b=C(()=>{var z;const{checkedRowKeys:A}=e,U=A===void 0?l.value:A;return((z=a.value)===null||z===void 0?void 0:z.multiple)===!1?{checkedKeys:U.slice(0,1),indeterminateKeys:[]}:n.value.getCheckedKeys(U,{cascade:e.cascade,allowNotLoaded:e.allowCheckingNotLoaded})}),f=C(()=>b.value.checkedKeys),c=C(()=>b.value.indeterminateKeys),u=C(()=>new Set(f.value)),S=C(()=>new Set(c.value)),F=C(()=>{const{value:z}=u;return t.value.reduce((A,U)=>{const{key:Y,disabled:g}=U;return A+(!g&&z.has(Y)?1:0)},0)}),_=C(()=>t.value.filter(z=>z.disabled).length),h=C(()=>{const{length:z}=t.value,{value:A}=S;return F.value>0&&F.value<z-_.value||t.value.some(U=>A.has(U.key))}),i=C(()=>{const{length:z}=t.value;return F.value!==0&&F.value===z-_.value}),v=C(()=>t.value.length===0);function s(z,A,U){const{"onUpdate:checkedRowKeys":Y,onUpdateCheckedRowKeys:g,onCheckedRowKeysChange:p}=e,B=[],{value:{getNode:y}}=n;z.forEach(V=>{var I;const $=(I=y(V))===null||I===void 0?void 0:I.rawNode;B.push($)}),Y&&ne(Y,z,B,{row:A,action:U}),g&&ne(g,z,B,{row:A,action:U}),p&&ne(p,z,B,{row:A,action:U}),l.value=z}function m(z,A=!1,U){if(!e.loading){if(A){s(Array.isArray(z)?z.slice(0,1):[z],U,"check");return}s(n.value.check(z,f.value,{cascade:e.cascade,allowNotLoaded:e.allowCheckingNotLoaded}).checkedKeys,U,"check")}}function R(z,A){e.loading||s(n.value.uncheck(z,f.value,{cascade:e.cascade,allowNotLoaded:e.allowCheckingNotLoaded}).checkedKeys,A,"uncheck")}function w(z=!1){const{value:A}=a;if(!A||e.loading)return;const U=[];(z?n.value.treeNodes:t.value).forEach(Y=>{Y.disabled||U.push(Y.key)}),s(n.value.check(U,f.value,{cascade:!0,allowNotLoaded:e.allowCheckingNotLoaded}).checkedKeys,void 0,"checkAll")}function N(z=!1){const{value:A}=a;if(!A||e.loading)return;const U=[];(z?n.value.treeNodes:t.value).forEach(Y=>{Y.disabled||U.push(Y.key)}),s(n.value.uncheck(U,f.value,{cascade:!0,allowNotLoaded:e.allowCheckingNotLoaded}).checkedKeys,void 0,"uncheckAll")}return{mergedCheckedRowKeySetRef:u,mergedCheckedRowKeysRef:f,mergedInderminateRowKeySetRef:S,someRowsCheckedRef:h,allRowsCheckedRef:i,headerCheckboxDisabledRef:v,doUpdateCheckedRowKeys:s,doCheckAll:w,doUncheckAll:N,doCheck:m,doUncheck:R}}function Mn(e,r){const t=De(()=>{for(const u of e.columns)if(u.type==="expand")return u.renderExpand}),n=De(()=>{let u;for(const S of e.columns)if(S.type==="expand"){u=S.expandable;break}return u}),a=j(e.defaultExpandAll?t!=null&&t.value?(()=>{const u=[];return r.value.treeNodes.forEach(S=>{var F;!((F=n.value)===null||F===void 0)&&F.call(n,S.rawNode)&&u.push(S.key)}),u})():r.value.getNonLeafKeys():e.defaultExpandedRowKeys),l=Q(e,"expandedRowKeys"),b=Q(e,"stickyExpandedRows"),f=xt(l,a);function c(u){const{onUpdateExpandedRowKeys:S,"onUpdate:expandedRowKeys":F}=e;S&&ne(S,u),F&&ne(F,u),a.value=u}return{stickyExpandedRowsRef:b,mergedExpandedRowKeysRef:f,renderExpandRef:t,expandableRef:n,doUpdateExpandedRowKeys:c}}function _n(e,r){const t=[],n=[],a=[],l=new WeakMap;let b=-1,f=0,c=!1,u=0;function S(_,h){h>b&&(t[h]=[],b=h),_.forEach(i=>{if("children"in i)S(i.children,h+1);else{const v="key"in i?i.key:void 0;n.push({key:Fe(i),style:dn(i,v!==void 0?ke(r(v)):void 0),column:i,index:u++,width:i.width===void 0?128:Number(i.width)}),f+=1,c||(c=!!i.ellipsis),a.push(i)}})}S(e,0),u=0;function F(_,h){let i=0;_.forEach(v=>{var s;if("children"in v){const m=u,R={column:v,colIndex:u,colSpan:0,rowSpan:1,isLast:!1};F(v.children,h+1),v.children.forEach(w=>{var N,z;R.colSpan+=(z=(N=l.get(w))===null||N===void 0?void 0:N.colSpan)!==null&&z!==void 0?z:0}),m+R.colSpan===f&&(R.isLast=!0),l.set(v,R),t[h].push(R)}else{if(u<i){u+=1;return}let m=1;"titleColSpan"in v&&(m=(s=v.titleColSpan)!==null&&s!==void 0?s:1),m>1&&(i=u+m);const R=u+m===f,w={column:v,colSpan:m,colIndex:u,rowSpan:b-h+1,isLast:R};l.set(v,w),t[h].push(w),u+=1}})}return F(e,0),{hasEllipsis:c,rows:t,cols:n,dataRelatedCols:a}}function Nn(e,r){const t=C(()=>_n(e.columns,r));return{rowsRef:C(()=>t.value.rows),colsRef:C(()=>t.value.cols),hasEllipsisRef:C(()=>t.value.hasEllipsis),dataRelatedColsRef:C(()=>t.value.dataRelatedCols)}}function $n(){const e=j({});function r(a){return e.value[a]}function t(a,l){qt(a)&&"key"in a&&(e.value[a.key]=l)}function n(){e.value={}}return{getResizableWidth:r,doUpdateResizableWidth:t,clearResizableWidth:n}}function Un(e,{mainTableInstRef:r,mergedCurrentPageRef:t,bodyWidthRef:n}){let a=0;const l=j(),b=j(null),f=j([]),c=j(null),u=j([]),S=C(()=>ke(e.scrollX)),F=C(()=>e.columns.filter(g=>g.fixed==="left")),_=C(()=>e.columns.filter(g=>g.fixed==="right")),h=C(()=>{const g={};let p=0;function B(y){y.forEach(V=>{const I={start:p,end:0};g[Fe(V)]=I,"children"in V?(B(V.children),I.end=p):(p+=Et(V)||0,I.end=p)})}return B(F.value),g}),i=C(()=>{const g={};let p=0;function B(y){for(let V=y.length-1;V>=0;--V){const I=y[V],$={start:p,end:0};g[Fe(I)]=$,"children"in I?(B(I.children),$.end=p):(p+=Et(I)||0,$.end=p)}}return B(_.value),g});function v(){var g,p;const{value:B}=F;let y=0;const{value:V}=h;let I=null;for(let $=0;$<B.length;++$){const W=Fe(B[$]);if(a>(((g=V[W])===null||g===void 0?void 0:g.start)||0)-y)I=W,y=((p=V[W])===null||p===void 0?void 0:p.end)||0;else break}b.value=I}function s(){f.value=[];let g=e.columns.find(p=>Fe(p)===b.value);for(;g&&"children"in g;){const p=g.children.length;if(p===0)break;const B=g.children[p-1];f.value.push(Fe(B)),g=B}}function m(){var g,p;const{value:B}=_,y=Number(e.scrollX),{value:V}=n;if(V===null)return;let I=0,$=null;const{value:W}=i;for(let Z=B.length-1;Z>=0;--Z){const X=Fe(B[Z]);if(Math.round(a+(((g=W[X])===null||g===void 0?void 0:g.start)||0)+V-I)<y)$=X,I=((p=W[X])===null||p===void 0?void 0:p.end)||0;else break}c.value=$}function R(){u.value=[];let g=e.columns.find(p=>Fe(p)===c.value);for(;g&&"children"in g&&g.children.length;){const p=g.children[0];u.value.push(Fe(p)),g=p}}function w(){const g=r.value?r.value.getHeaderElement():null,p=r.value?r.value.getBodyElement():null;return{header:g,body:p}}function N(){const{body:g}=w();g&&(g.scrollTop=0)}function z(){l.value!=="body"?Tt(U):l.value=void 0}function A(g){var p;(p=e.onScroll)===null||p===void 0||p.call(e,g),l.value!=="head"?Tt(U):l.value=void 0}function U(){const{header:g,body:p}=w();if(!p)return;const{value:B}=n;if(B!==null){if(e.maxHeight||e.flexHeight){if(!g)return;const y=a-g.scrollLeft;l.value=y!==0?"head":"body",l.value==="head"?(a=g.scrollLeft,p.scrollLeft=a):(a=p.scrollLeft,g.scrollLeft=a)}else a=p.scrollLeft;v(),s(),m(),R()}}function Y(g){const{header:p}=w();p&&(p.scrollLeft=g,U())}return $r(t,()=>{N()}),{styleScrollXRef:S,fixedColumnLeftMapRef:h,fixedColumnRightMapRef:i,leftFixedColumnsRef:F,rightFixedColumnsRef:_,leftActiveFixedColKeyRef:b,leftActiveFixedChildrenColKeysRef:f,rightActiveFixedColKeyRef:c,rightActiveFixedChildrenColKeysRef:u,syncScrollState:U,handleTableBodyScroll:A,handleTableHeaderScroll:z,setHeaderScrollLeft:Y}}function at(e){return typeof e=="object"&&typeof e.multiple=="number"?e.multiple:!1}function Hn(e,r){return r&&(e===void 0||e==="default"||typeof e=="object"&&e.compare==="default")?Bn(r):typeof e=="function"?e:e&&typeof e=="object"&&e.compare&&e.compare!=="default"?e.compare:!1}function Bn(e){return(r,t)=>{const n=r[e],a=t[e];return n==null?a==null?0:-1:a==null?1:typeof n=="number"&&typeof a=="number"?n-a:typeof n=="string"&&typeof a=="string"?n.localeCompare(a):0}}function Dn(e,{dataRelatedColsRef:r,filteredDataRef:t}){const n=[];r.value.forEach(h=>{var i;h.sorter!==void 0&&_(n,{columnKey:h.key,sorter:h.sorter,order:(i=h.defaultSortOrder)!==null&&i!==void 0?i:!1})});const a=j(n),l=C(()=>{const h=r.value.filter(s=>s.type!=="selection"&&s.sorter!==void 0&&(s.sortOrder==="ascend"||s.sortOrder==="descend"||s.sortOrder===!1)),i=h.filter(s=>s.sortOrder!==!1);if(i.length)return i.map(s=>({columnKey:s.key,order:s.sortOrder,sorter:s.sorter}));if(h.length)return[];const{value:v}=a;return Array.isArray(v)?v:v?[v]:[]}),b=C(()=>{const h=l.value.slice().sort((i,v)=>{const s=at(i.sorter)||0;return(at(v.sorter)||0)-s});return h.length?t.value.slice().sort((v,s)=>{let m=0;return h.some(R=>{const{columnKey:w,sorter:N,order:z}=R,A=Hn(N,w);return A&&z&&(m=A(v.rawNode,s.rawNode),m!==0)?(m=m*an(z),!0):!1}),m}):t.value});function f(h){let i=l.value.slice();return h&&at(h.sorter)!==!1?(i=i.filter(v=>at(v.sorter)!==!1),_(i,h),i):h||null}function c(h){const i=f(h);u(i)}function u(h){const{"onUpdate:sorter":i,onUpdateSorter:v,onSorterChange:s}=e;i&&ne(i,h),v&&ne(v,h),s&&ne(s,h),a.value=h}function S(h,i="ascend"){if(!h)F();else{const v=r.value.find(m=>m.type!=="selection"&&m.type!=="expand"&&m.key===h);if(!(v!=null&&v.sorter))return;const s=v.sorter;c({columnKey:h,sorter:s,order:i})}}function F(){u(null)}function _(h,i){const v=h.findIndex(s=>(i==null?void 0:i.columnKey)&&s.columnKey===i.columnKey);v!==void 0&&v>=0?h[v]=i:h.push(i)}return{clearSorter:F,sort:S,sortedDataRef:b,mergedSortStateRef:l,deriveNextSorter:c}}function In(e,{dataRelatedColsRef:r}){const t=C(()=>{const d=k=>{for(let K=0;K<k.length;++K){const P=k[K];if("children"in P)return d(P.children);if(P.type==="selection")return P}return null};return d(e.columns)}),n=C(()=>{const{childrenKey:d}=e;return Yr(e.data,{ignoreEmptyChildren:!0,getKey:e.rowKey,getChildren:k=>k[d],getDisabled:k=>{var K,P;return!!(!((P=(K=t.value)===null||K===void 0?void 0:K.disabled)===null||P===void 0)&&P.call(K,k))}})}),a=De(()=>{const{columns:d}=e,{length:k}=d;let K=null;for(let P=0;P<k;++P){const H=d[P];if(!H.type&&K===null&&(K=P),"tree"in H&&H.tree)return P}return K||0}),l=j({}),{pagination:b}=e,f=j(b&&b.defaultPage||1),c=j(Qr(b)),u=C(()=>{const d=r.value.filter(P=>P.filterOptionValues!==void 0||P.filterOptionValue!==void 0),k={};return d.forEach(P=>{var H;P.type==="selection"||P.type==="expand"||(P.filterOptionValues===void 0?k[P.key]=(H=P.filterOptionValue)!==null&&H!==void 0?H:null:k[P.key]=P.filterOptionValues)}),Object.assign(Kt(l.value),k)}),S=C(()=>{const d=u.value,{columns:k}=e;function K(ie){return(ge,ce)=>!!~String(ce[ie]).indexOf(String(ge))}const{value:{treeNodes:P}}=n,H=[];return k.forEach(ie=>{ie.type==="selection"||ie.type==="expand"||"children"in ie||H.push([ie.key,ie])}),P?P.filter(ie=>{const{rawNode:ge}=ie;for(const[ce,Re]of H){let le=d[ce];if(le==null||(Array.isArray(le)||(le=[le]),!le.length))continue;const Oe=Re.filter==="default"?K(ce):Re.filter;if(Re&&typeof Oe=="function")if(Re.filterMode==="and"){if(le.some(ue=>!Oe(ue,ge)))return!1}else{if(le.some(ue=>Oe(ue,ge)))continue;return!1}}return!0}):[]}),{sortedDataRef:F,deriveNextSorter:_,mergedSortStateRef:h,sort:i,clearSorter:v}=Dn(e,{dataRelatedColsRef:r,filteredDataRef:S});r.value.forEach(d=>{var k;if(d.filter){const K=d.defaultFilterOptionValues;d.filterMultiple?l.value[d.key]=K||[]:K!==void 0?l.value[d.key]=K===null?[]:K:l.value[d.key]=(k=d.defaultFilterOptionValue)!==null&&k!==void 0?k:null}});const s=C(()=>{const{pagination:d}=e;if(d!==!1)return d.page}),m=C(()=>{const{pagination:d}=e;if(d!==!1)return d.pageSize}),R=xt(s,f),w=xt(m,c),N=De(()=>{const d=R.value;return e.remote?d:Math.max(1,Math.min(Math.ceil(S.value.length/w.value),d))}),z=C(()=>{const{pagination:d}=e;if(d){const{pageCount:k}=d;if(k!==void 0)return k}}),A=C(()=>{if(e.remote)return n.value.treeNodes;if(!e.pagination)return F.value;const d=w.value,k=(N.value-1)*d;return F.value.slice(k,k+d)}),U=C(()=>A.value.map(d=>d.rawNode));function Y(d){const{pagination:k}=e;if(k){const{onChange:K,"onUpdate:page":P,onUpdatePage:H}=k;K&&ne(K,d),H&&ne(H,d),P&&ne(P,d),y(d)}}function g(d){const{pagination:k}=e;if(k){const{onPageSizeChange:K,"onUpdate:pageSize":P,onUpdatePageSize:H}=k;K&&ne(K,d),H&&ne(H,d),P&&ne(P,d),V(d)}}const p=C(()=>{if(e.remote){const{pagination:d}=e;if(d){const{itemCount:k}=d;if(k!==void 0)return k}return}return S.value.length}),B=C(()=>Object.assign(Object.assign({},e.pagination),{onChange:void 0,onUpdatePage:void 0,onUpdatePageSize:void 0,onPageSizeChange:void 0,"onUpdate:page":Y,"onUpdate:pageSize":g,page:N.value,pageSize:w.value,pageCount:p.value===void 0?z.value:void 0,itemCount:p.value}));function y(d){const{"onUpdate:page":k,onPageChange:K,onUpdatePage:P}=e;P&&ne(P,d),k&&ne(k,d),K&&ne(K,d),f.value=d}function V(d){const{"onUpdate:pageSize":k,onPageSizeChange:K,onUpdatePageSize:P}=e;K&&ne(K,d),P&&ne(P,d),k&&ne(k,d),c.value=d}function I(d,k){const{onUpdateFilters:K,"onUpdate:filters":P,onFiltersChange:H}=e;K&&ne(K,d,k),P&&ne(P,d,k),H&&ne(H,d,k),l.value=d}function $(d,k,K,P){var H;(H=e.onUnstableColumnResize)===null||H===void 0||H.call(e,d,k,K,P)}function W(d){y(d)}function Z(){X()}function X(){J({})}function J(d){se(d)}function se(d){d?d&&(l.value=Kt(d)):l.value={}}return{treeMateRef:n,mergedCurrentPageRef:N,mergedPaginationRef:B,paginatedDataRef:A,rawPaginatedDataRef:U,mergedFilterStateRef:u,mergedSortStateRef:h,hoverKeyRef:j(null),selectionColumnRef:t,childTriggerColIndexRef:a,doUpdateFilters:I,deriveNextSorter:_,doUpdatePageSize:V,doUpdatePage:y,onUnstableColumnResize:$,filter:se,filters:J,clearFilter:Z,clearFilters:X,clearSorter:v,page:W,sort:i}}const to=ae({name:"DataTable",alias:["AdvancedTable"],props:nn,slots:Object,setup(e,{slots:r}){const{mergedBorderedRef:t,mergedClsPrefixRef:n,inlineThemeDisabled:a,mergedRtlRef:l}=dt(e),b=Ht("DataTable",l,n),f=C(()=>{const{bottomBordered:L}=e;return t.value?!1:L!==void 0?L:!0}),c=lt("DataTable","-data-table",Kn,jr,e,n),u=j(null),S=j(null),{getResizableWidth:F,clearResizableWidth:_,doUpdateResizableWidth:h}=$n(),{rowsRef:i,colsRef:v,dataRelatedColsRef:s,hasEllipsisRef:m}=Nn(e,F),{treeMateRef:R,mergedCurrentPageRef:w,paginatedDataRef:N,rawPaginatedDataRef:z,selectionColumnRef:A,hoverKeyRef:U,mergedPaginationRef:Y,mergedFilterStateRef:g,mergedSortStateRef:p,childTriggerColIndexRef:B,doUpdatePage:y,doUpdateFilters:V,onUnstableColumnResize:I,deriveNextSorter:$,filter:W,filters:Z,clearFilter:X,clearFilters:J,clearSorter:se,page:d,sort:k}=In(e,{dataRelatedColsRef:s}),K=L=>{const{fileName:E="data.csv",keepOriginalData:ee=!1}=L||{},te=ee?e.data:z.value,oe=fn(e.columns,te,e.getCsvCell,e.getCsvHeader),ye=new Blob([oe],{type:"text/csv;charset=utf-8"}),xe=URL.createObjectURL(ye);en(xe,E.endsWith(".csv")?E:`${E}.csv`),URL.revokeObjectURL(xe)},{doCheckAll:P,doUncheckAll:H,doCheck:ie,doUncheck:ge,headerCheckboxDisabledRef:ce,someRowsCheckedRef:Re,allRowsCheckedRef:le,mergedCheckedRowKeySetRef:Oe,mergedInderminateRowKeySetRef:ue}=An(e,{selectionColumnRef:A,treeMateRef:R,paginatedDataRef:N}),{stickyExpandedRowsRef:Ee,mergedExpandedRowKeysRef:Me,renderExpandRef:Ie,expandableRef:Ke,doUpdateExpandedRowKeys:_e}=Mn(e,R),{handleTableBodyScroll:He,handleTableHeaderScroll:O,syncScrollState:q,setHeaderScrollLeft:ve,leftActiveFixedColKeyRef:fe,leftActiveFixedChildrenColKeysRef:Be,rightActiveFixedColKeyRef:qe,rightActiveFixedChildrenColKeysRef:Xe,leftFixedColumnsRef:be,rightFixedColumnsRef:he,fixedColumnLeftMapRef:Ge,fixedColumnRightMapRef:Ye}=Un(e,{bodyWidthRef:u,mainTableInstRef:S,mergedCurrentPageRef:w}),{localeRef:Pe}=Hr("DataTable"),pe=C(()=>e.virtualScroll||e.flexHeight||e.maxHeight!==void 0||m.value?"fixed":e.tableLayout);Br(Te,{props:e,treeMateRef:R,renderExpandIconRef:Q(e,"renderExpandIcon"),loadingKeySetRef:j(new Set),slots:r,indentRef:Q(e,"indent"),childTriggerColIndexRef:B,bodyWidthRef:u,componentId:Dr(),hoverKeyRef:U,mergedClsPrefixRef:n,mergedThemeRef:c,scrollXRef:C(()=>e.scrollX),rowsRef:i,colsRef:v,paginatedDataRef:N,leftActiveFixedColKeyRef:fe,leftActiveFixedChildrenColKeysRef:Be,rightActiveFixedColKeyRef:qe,rightActiveFixedChildrenColKeysRef:Xe,leftFixedColumnsRef:be,rightFixedColumnsRef:he,fixedColumnLeftMapRef:Ge,fixedColumnRightMapRef:Ye,mergedCurrentPageRef:w,someRowsCheckedRef:Re,allRowsCheckedRef:le,mergedSortStateRef:p,mergedFilterStateRef:g,loadingRef:Q(e,"loading"),rowClassNameRef:Q(e,"rowClassName"),mergedCheckedRowKeySetRef:Oe,mergedExpandedRowKeysRef:Me,mergedInderminateRowKeySetRef:ue,localeRef:Pe,expandableRef:Ke,stickyExpandedRowsRef:Ee,rowKeyRef:Q(e,"rowKey"),renderExpandRef:Ie,summaryRef:Q(e,"summary"),virtualScrollRef:Q(e,"virtualScroll"),virtualScrollXRef:Q(e,"virtualScrollX"),heightForRowRef:Q(e,"heightForRow"),minRowHeightRef:Q(e,"minRowHeight"),virtualScrollHeaderRef:Q(e,"virtualScrollHeader"),headerHeightRef:Q(e,"headerHeight"),rowPropsRef:Q(e,"rowProps"),stripedRef:Q(e,"striped"),checkOptionsRef:C(()=>{const{value:L}=A;return L==null?void 0:L.options}),rawPaginatedDataRef:z,filterMenuCssVarsRef:C(()=>{const{self:{actionDividerColor:L,actionPadding:E,actionButtonMargin:ee}}=c.value;return{"--n-action-padding":E,"--n-action-button-margin":ee,"--n-action-divider-color":L}}),onLoadRef:Q(e,"onLoad"),mergedTableLayoutRef:pe,maxHeightRef:Q(e,"maxHeight"),minHeightRef:Q(e,"minHeight"),flexHeightRef:Q(e,"flexHeight"),headerCheckboxDisabledRef:ce,paginationBehaviorOnFilterRef:Q(e,"paginationBehaviorOnFilter"),summaryPlacementRef:Q(e,"summaryPlacement"),filterIconPopoverPropsRef:Q(e,"filterIconPopoverProps"),scrollbarPropsRef:Q(e,"scrollbarProps"),syncScrollState:q,doUpdatePage:y,doUpdateFilters:V,getResizableWidth:F,onUnstableColumnResize:I,clearResizableWidth:_,doUpdateResizableWidth:h,deriveNextSorter:$,doCheck:ie,doUncheck:ge,doCheckAll:P,doUncheckAll:H,doUpdateExpandedRowKeys:_e,handleTableHeaderScroll:O,handleTableBodyScroll:He,setHeaderScrollLeft:ve,renderCell:Q(e,"renderCell")});const Ne={filter:W,filters:Z,clearFilters:J,clearSorter:se,page:d,sort:k,clearFilter:X,downloadCsv:K,scrollTo:(L,E)=>{var ee;(ee=S.value)===null||ee===void 0||ee.scrollTo(L,E)}},de=C(()=>{const{size:L}=e,{common:{cubicBezierEaseInOut:E},self:{borderColor:ee,tdColorHover:te,tdColorSorting:oe,tdColorSortingModal:ye,tdColorSortingPopover:xe,thColorSorting:Le,thColorSortingModal:Ze,thColorSortingPopover:Ce,thColor:re,thColorHover:$e,tdColor:et,tdTextColor:tt,thTextColor:je,thFontWeight:Ve,thButtonColorHover:st,thIconColor:ct,thIconColorActive:We,filterSize:rt,borderRadius:Qe,lineHeight:Ae,tdColorModal:nt,thColorModal:ut,borderColorModal:me,thColorHoverModal:we,tdColorHoverModal:er,borderColorPopover:tr,thColorPopover:rr,tdColorPopover:nr,tdColorHoverPopover:or,thColorHoverPopover:ar,paginationMargin:lr,emptyPadding:ir,boxShadowAfter:dr,boxShadowBefore:sr,sorterSize:cr,resizableContainerSize:ur,resizableSize:fr,loadingColor:hr,loadingSize:gr,opacityLoading:vr,tdColorStriped:pr,tdColorStripedModal:mr,tdColorStripedPopover:br,[ht("fontSize",L)]:yr,[ht("thPadding",L)]:xr,[ht("tdPadding",L)]:Rr}}=c.value;return{"--n-font-size":yr,"--n-th-padding":xr,"--n-td-padding":Rr,"--n-bezier":E,"--n-border-radius":Qe,"--n-line-height":Ae,"--n-border-color":ee,"--n-border-color-modal":me,"--n-border-color-popover":tr,"--n-th-color":re,"--n-th-color-hover":$e,"--n-th-color-modal":ut,"--n-th-color-hover-modal":we,"--n-th-color-popover":rr,"--n-th-color-hover-popover":ar,"--n-td-color":et,"--n-td-color-hover":te,"--n-td-color-modal":nt,"--n-td-color-hover-modal":er,"--n-td-color-popover":nr,"--n-td-color-hover-popover":or,"--n-th-text-color":je,"--n-td-text-color":tt,"--n-th-font-weight":Ve,"--n-th-button-color-hover":st,"--n-th-icon-color":ct,"--n-th-icon-color-active":We,"--n-filter-size":rt,"--n-pagination-margin":lr,"--n-empty-padding":ir,"--n-box-shadow-before":sr,"--n-box-shadow-after":dr,"--n-sorter-size":cr,"--n-resizable-container-size":ur,"--n-resizable-size":fr,"--n-loading-size":gr,"--n-loading-color":hr,"--n-opacity-loading":vr,"--n-td-color-striped":pr,"--n-td-color-striped-modal":mr,"--n-td-color-striped-popover":br,"--n-td-color-sorting":oe,"--n-td-color-sorting-modal":ye,"--n-td-color-sorting-popover":xe,"--n-th-color-sorting":Le,"--n-th-color-sorting-modal":Ze,"--n-th-color-sorting-popover":Ce}}),x=a?Ir("data-table",C(()=>e.size[0]),de,e):void 0,M=C(()=>{if(!e.pagination)return!1;if(e.paginateSinglePage)return!0;const L=Y.value,{pageCount:E}=L;return E!==void 0?E>1:L.itemCount&&L.pageSize&&L.itemCount>L.pageSize});return Object.assign({mainTableInstRef:S,mergedClsPrefix:n,rtlEnabled:b,mergedTheme:c,paginatedData:N,mergedBordered:t,mergedBottomBordered:f,mergedPagination:Y,mergedShowPagination:M,cssVars:a?void 0:de,themeClass:x==null?void 0:x.themeClass,onRender:x==null?void 0:x.onRender},Ne)},render(){const{mergedClsPrefix:e,themeClass:r,onRender:t,$slots:n,spinProps:a}=this;return t==null||t(),o("div",{class:[`${e}-data-table`,this.rtlEnabled&&`${e}-data-table--rtl`,r,{[`${e}-data-table--bordered`]:this.mergedBordered,[`${e}-data-table--bottom-bordered`]:this.mergedBottomBordered,[`${e}-data-table--single-line`]:this.singleLine,[`${e}-data-table--single-column`]:this.singleColumn,[`${e}-data-table--loading`]:this.loading,[`${e}-data-table--flex-height`]:this.flexHeight}],style:this.cssVars},o("div",{class:`${e}-data-table-wrapper`},o(En,{ref:"mainTableInstRef"})),this.mergedShowPagination?o("div",{class:`${e}-data-table__pagination`},o(Jr,Object.assign({theme:this.mergedTheme.peers.Pagination,themeOverrides:this.mergedTheme.peerOverrides.Pagination,disabled:this.loading},this.mergedPagination))):null,o(Ur,{name:"fade-in-scale-up-transition"},{default:()=>this.loading?o("div",{class:`${e}-data-table-loading-wrapper`},Dt(n.loading,()=>[o($t,Object.assign({clsPrefix:e,strokeWidth:20},a))])):null}))}});export{to as N};
