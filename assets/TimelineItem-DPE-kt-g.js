import{m as O,aF as V,d8 as W,c as t,b as d,a as g,d as l,e as S,u as y,f as $,h as s,k as E,p as H,ap as v,q as z,au as K,g as M,j as x,n as L,ah as p,aC as q}from"./index-5AkqUtzD.js";let b=!1;function D(){if(O&&window.CSS&&!b&&(b=!0,"registerProperty"in(window==null?void 0:window.CSS)))try{CSS.registerProperty({name:"--n-color-start",syntax:"<color>",inherits:!1,initialValue:"#0000"}),CSS.registerProperty({name:"--n-color-end",syntax:"<color>",inherits:!1,initialValue:"#0000"})}catch{}}function A(e){const{textColor3:n,infoColor:o,errorColor:r,successColor:i,warningColor:a,textColor1:c,textColor2:m,railColor:h,fontWeightStrong:f,fontSize:u}=e;return Object.assign(Object.assign({},W),{contentFontSize:u,titleFontWeight:f,circleBorder:`2px solid ${n}`,circleBorderInfo:`2px solid ${o}`,circleBorderError:`2px solid ${r}`,circleBorderSuccess:`2px solid ${i}`,circleBorderWarning:`2px solid ${a}`,iconColor:n,iconColorInfo:o,iconColorError:r,iconColorSuccess:i,iconColorWarning:a,titleTextColor:c,contentTextColor:m,metaTextColor:n,lineColor:h})}const G={common:V,self:A},C=1.25,J=t("timeline",`
 position: relative;
 width: 100%;
 display: flex;
